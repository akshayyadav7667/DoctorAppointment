...
import { AddDoctor, changeDoctorStatus, getAllAppointment, getAllDoctorforApproval, getDetails } from '../controllers/AdminController.js';
...
adminRouter.get('/allAppovalDoctor',ProtectedAuth, authorizeRoles('admin'),getAllDoctorforApproval)
adminRouter.post('/addDoctor',ProtectedAuth, authorizeRoles('admin'), uploadDoctor.single('doctor_image'), AddDoctor)
