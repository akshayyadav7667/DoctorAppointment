      ...
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="flex-1  mt-12 ml-5 space-y-4">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div >
              <h2 className="text-blue-600 font-semibold mb-1 ">Accessibility</h2>
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div >
              <h2 className="text-blue-600 font-semibold mb-1 ">Cost-Efficiency</h2>
              <p className="text-gray-700 ">
          ...
          <div className="flex justify-center items-center gap-4">
            <AlarmClockPlus className="w-10 h-10 text-blue-500" />
            <div >
              <h2 className="text-blue-600 font-semibold mb-1 ">Timely Assistance</h2>
              <p className="text-gray-700 ">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div >
              <h2 className="text-blue-600 font-semibold mb-1 ">Secure Communication</h2>
              <p className="text-gray-700 ">
          ...
          <div className="flex justify-center items-center gap-4">
            <BriefcaseMedical className="w-10 h-10 text-blue-500" />
            <div >
              <h2 className="text-blue-600 font-semibold mb-1 ">Expert Medical Opinion</h2>
              <p className="text-gray-700 ">
