...
export default function Specialities() {
  return (
    <div className="flex flex-col items-center py-16 gap-4 ">
      <h1 className="text-3xl text-gray-700 font-semibold">Find by Speciality</h1>
      ...
      <div className="flex sm:justify-center items-center gap-5 pt-5 w-full overflow-scroll ">
        {specialityData.map((item) => (
          <Link className="flex flex-col items-center text-sm hover:translate-y-[-10px] transform transition duration-300 " key={item.speciality}>
