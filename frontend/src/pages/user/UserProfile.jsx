...
export default function UserProfile() {
  const { user, userToken, setUser, backendUrl } = useContext(AuthContext);
      ...
      <div className="bg-gradient-to-r from-indigo-400 to-orange-400 h-32 relative">
        <div className="absolute left-1/2 transform -translate-x-1/2 top-16">
          {/* <img
            ...
            alt="Profile"
            className="w-32 h-32 rounded-full border-4 cursor-pointer border-white shadow-lg object-cover"
          /> */}
